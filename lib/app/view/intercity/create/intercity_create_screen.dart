...
import 'package:jetu.driver/app/view/intercity/create/bloc/intercity_create_cubit.dart';
        ...
        builder: (context, authState) {
          return Scaffold(
            ...
            body: SubscriptionWrapper<IntercityOrderModelList>(
              ...
              variables: {"driverId": authState.userId},
            ...
            children: [
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () => context.read<IntercityCreateCubit>()..order(),
                  child: AppButtonV1(
        ...
        builder: (context, state) {
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Ваш объявление успешно создан,ожидайте звонки от пассажиров',
